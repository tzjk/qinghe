...
<template>
  <el-container class="admin-shell">
    <el-aside width="220px"><h2>青禾后台</h2><el-menu :default-active="$route.path" router><el-menu-item index="/admin">管理首页</el-menu-item><el-menu-item index="/admin/shops">店铺管理</el-menu-item><el-menu-item index="/admin/goods/categories">商品分类</el-menu-item><el-menu-item index="/admin/goods">商品管理</el-menu-item><el-menu-item index="/admin/orders">订单管理</el-menu-item><el-menu-item index="/admin/coupons">优惠管理</el-menu-item><el-menu-item index="/admin/dorm/students">学生学籍</el-menu-item><el-menu-item index="/admin/dorm">宿舍管理</el-menu-item><el-menu-item index="/admin/dorm/checkins">入住管理</el-menu-item></el-menu></el-aside>
    <el-container>
